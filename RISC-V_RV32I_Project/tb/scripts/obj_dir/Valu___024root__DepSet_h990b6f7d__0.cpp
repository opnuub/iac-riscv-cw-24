    ...
    vlSelfRef.result_o = ((8U & (IData)(vlSelfRef.operator_i))
                           ...
                           : ((4U & (IData)(vlSelfRef.operator_i))
                               ? ((2U & (IData)(vlSelfRef.operator_i))
                                   ? ((1U & (IData)(vlSelfRef.operator_i))
                                       ? VL_SHIFTRS_III(32,32,5, vlSelfRef.operand_a_i, 
                                                        (0x1fU 
                                                         & vlSelfRef.operand_b_i))
                                       : (vlSelfRef.operand_a_i 
                                          >> (0x1fU 
                               ...
                               : ((2U & (IData)(vlSelfRef.operator_i))
                                   ? ((1U & (IData)(vlSelfRef.operator_i))
                                       ? VL_LTS_III(32, vlSelfRef.operand_a_i, vlSelfRef.operand_b_i)
                                       : (vlSelfRef.operand_a_i 
                                          << (0x1fU 
                                              & vlSelfRef.operand_b_i)))
                                   : ((1U == (IData)(vlSelfRef.operator_i))
...
#endif
            VL_FATAL_MT("/Users/michaelli/Documents/GitHub/iac-riscv-cw-24/RISC-V_RV32I_Project/rtl/alu.sv", 1, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("/Users/michaelli/Documents/GitHub/iac-riscv-cw-24/RISC-V_RV32I_Project/rtl/alu.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/Users/michaelli/Documents/GitHub/iac-riscv-cw-24/RISC-V_RV32I_Project/rtl/alu.sv", 1, "", "Active region did not converge.");
            }
...
void Valu___024root___eval_debug_assertions(Valu___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (VL_UNLIKELY((vlSelfRef.operator_i & 0xf0U))) {
