...
void Vimem___024root___nba_sequent__TOP__0(Vimem___024root* vlSelf);
...
void Vimem___024root___eval_nba(Vimem___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        Vimem___024root___nba_sequent__TOP__0(vlSelf);
    }
}

VL_INLINE_OPT void Vimem___024root___nba_sequent__TOP__0(Vimem___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vimem__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vimem___024root___nba_sequent__TOP__0\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.rdata_o = ((vlSelfRef.imem__DOT__mem[
                          (3U | (0xffcU & vlSelfRef.addr_i))] 
                          << 0x18U) | ((vlSelfRef.imem__DOT__mem
                                        [(2U | (0xffcU 
                                                & vlSelfRef.addr_i))] 
                                        << 0x10U) | 
                                       ((vlSelfRef.imem__DOT__mem
                                         [(1U | (0xffcU 
                                                 & vlSelfRef.addr_i))] 
                                         << 8U) | vlSelfRef.imem__DOT__mem
                                        [(0xffcU & vlSelfRef.addr_i)])));
}

void Vimem___024root___eval_triggers__act(Vimem___024root* vlSelf);

bool Vimem___024root___eval_phase__act(Vimem___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vimem__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vimem___024root___eval_phase__act\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
bool Vimem___024root___eval_phase__nba(Vimem___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vimem__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vimem___024root___eval_phase__nba\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#endif
            VL_FATAL_MT("/Users/michaelli/Documents/GitHub/iac-riscv-cw-24/RISC-V_RV32I_Project/rtl/imem.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/Users/michaelli/Documents/GitHub/iac-riscv-cw-24/RISC-V_RV32I_Project/rtl/imem.sv", 1, "", "Active region did not converge.");
            }
            vlSelfRef.__VactIterCount = ((IData)(1U) 
                                         + vlSelfRef.__VactIterCount);
            vlSelfRef.__VactContinue = 0U;
            if (Vimem___024root___eval_phase__act(vlSelf)) {
                vlSelfRef.__VactContinue = 1U;
            }
        }
        if (Vimem___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
