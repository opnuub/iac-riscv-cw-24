...
#ifdef VL_DEBUG
VL_ATTR_COLD void VL1Cache___024root___dump_triggers__stl(VL1Cache___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool VL1Cache___024root___eval_phase__stl(VL1Cache___024root* vlSelf);
...
#ifdef VL_DEBUG
            VL1Cache___024root___dump_triggers__stl(vlSelf);
#endif
            VL_FATAL_MT("../../rtl/L1Cache.sv", 1, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (VL1Cache___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void VL1Cache___024root___dump_triggers__stl(VL1Cache___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VL1Cache__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VL1Cache___024root___dump_triggers__stl\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VL1Cache___024root___eval_stl(VL1Cache___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VL1Cache__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VL1Cache___024root___eval_stl\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
...
VL_ATTR_COLD void VL1Cache___024root___eval_triggers__stl(VL1Cache___024root* vlSelf);

VL_ATTR_COLD bool VL1Cache___024root___eval_phase__stl(VL1Cache___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VL1Cache__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VL1Cache___024root___eval_phase__stl\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    VL1Cache___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelfRef.__VstlTriggered.any();
    if (__VstlExecute) {
        VL1Cache___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void VL1Cache___024root___dump_triggers__ico(VL1Cache___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VL1Cache__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VL1Cache___024root___dump_triggers__ico\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VL1Cache___024root___ctor_var_reset(VL1Cache___024root* vlSelf) {
    ...
    vlSelf->L1Cache__DOT__state = VL_RAND_RESET_I(3);
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 2; ++__Vi1) {
            vlSelf->L1Cache__DOT__cache[__Vi0][__Vi1] = VL_RAND_RESET_Q(59);
        }
    }
    vlSelf->L1Cache__DOT__lru = VL_RAND_RESET_I(32);
    vlSelf->L1Cache__DOT__way = VL_RAND_RESET_I(1);
    vlSelf->L1Cache__DOT__hit_way = VL_RAND_RESET_I(1);
