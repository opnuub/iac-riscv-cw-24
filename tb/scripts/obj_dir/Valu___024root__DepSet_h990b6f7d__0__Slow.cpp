...
#endif
            VL_FATAL_MT("/Users/michaelli/Documents/GitHub/iac-riscv-cw-24/RISC-V_RV32I_Project/rtl/alu.sv", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Valu___024root___ctor_var_reset(Valu___024root* vlSelf) {
    ...
    vlSelf->operator_i = VL_RAND_RESET_I(4);
